...
class CSPDiffusion(BaseModule):
    ...
    def get_kl_dist(self, model_new, model_ref, batch, time_consts):
        ...
        time_emb, c0, c1, sigmas_per_atom, sigmas_norm_per_atom = time_consts
    ...
    def forward(self, batch):
        ...
        sigmas_per_atom = sigmas.repeat_interleave(batch_pos.num_atoms)[:, None]
        sigmas_norm_per_atom = sigmas_norm.repeat_interleave(batch_pos.num_atoms)[:, None]

        time_consts = (time_emb, c0, c1, sigmas_per_atom, sigmas_norm_per_atom)
    ...
    def sample(self, batch, step_lr = 1e-5):
        ...
        for t in tqdm(range(time_start, 0, -1)):
            ...
            # step_size = self.sigma_scheduler.step_size[t]
    ...
    def compute_stats(self, output_dict, prefix):
        ...
        log_dict = {
            f'{prefix}_loss': loss,
            f'{prefix}_pos_dist': pos_dist,
            f'{prefix}_neg_dist': neg_dist
        }
