...
class CSPFlow(BaseModule):
    ...
    def get_kl_dist(self, model_new, model_ref, batch, time_consts):
        ...
        time_emb, c0, c1, sigmas, sigmas_norm = time_consts
    ...
    def forward(self, batch):
        ...
        time_consts = (time_emb, c0, c1, sigmas, sigmas_norm)
    ...
    def flow_forward(self, batch):
        ...
        rand_l, rand_x = torch.randn_like(lattices), torch.randn_like(frac_coords) # x0
    ...
    def sample(self, batch, diff_ratio = 1.0, step_lr = 1e-5):
        ...
        for t in tqdm(range(time_start, 0, -1)):
            ...
            l_step_size = 1. / self.timesteps

            x_t_minus_1 = x_t_minus_05 - step_size * pred_x + std_x * rand_x 
            l_t_minus_1 = l_t - l_step_size * (pred_l - l_t) / (1. - t * l_step_size)
